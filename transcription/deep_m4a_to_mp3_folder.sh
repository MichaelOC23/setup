...
FOLDER_PATH=$(pwd)
FOLDER_PATH="${FOLDER_PATH}/audio-raw"
...
#Make the folder: "${FOLDER_PATH}/../Transcriptions/" if it doesn't exist
mkdir -p "${FOLDER_PATH}/../transcriptions"
...
for mp3_file in "$FOLDER_PATH"/*.mp3; do
    ...
    transcription_path="${FOLDER_PATH}/../transcriptions/${file_name_only}.json"
